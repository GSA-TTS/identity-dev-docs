...
- **`urn:acr.login.gov:auth-only`**
    ...
    Meets either NIST 800-63-3/4 AAL1 or AAL2 standard (depending on agency integration configuration)
- **`urn:acr.login.gov:verified`**
    Requires that the user has gone through basic identity verification without facial matching.
    
    This meets the NIST 800-63-4 IAL1 standard, but does not meet the NIST 800-63-3/4 IAL2 standard.
- **`urn:acr.login.gov:verified-facial-match-required`**
    ...
    Meets NIST 800-63-3/4 IAL2 standard.
- **`urn:acr.login.gov:verified-facial-match-preferred`**
    ...
    Authentications for users who verify with facial matching will meet NIST 800-63-3/4 IAL2 standard. Authentication for users who do not do facial matching will not meet NIST 800-63-3 IAL2 standard, but will meet NIST 800-63-4 IAL1 standard.
{% endcapture %}
