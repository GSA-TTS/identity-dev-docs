...
=======
* Once you have successfully integrated your application with the Login.gov environment, users start at your application and are redirected back to Login.gov via [OIDC](/oidc/) or [SAML](/saml/) protocols.
>>>>>>> 69bc192 (fix some html-proofer errors)
...
* Upon successful completion of the account creation and authentication, users will be redirected back to your application with the [user attributes](/attributes/) that correspond to their user level.
...
=======
* Select between [OpenID Connect](/oidc/) (OIDC) or [SAML](/saml/) protocol implementation protocols and understand which user attributes are required.
* If you have questions when testing your app, read through our [FAQs](/support/) or submit a ticket to our [technical support help desk](/support/#contacting-partner-support).
* Before submitting a request to move your app to production, review the [User experience](/design-guidelines/) page and the [Production](/production/) page. Additional requirements, like a [signed Interagency agreement](/production/#confirm-interagency-agreement-iaa) (IAA) and [agency logo](/user-experience/agency-logo/), are described in these pages.     
>>>>>>> 69bc192 (fix some html-proofer errors)
