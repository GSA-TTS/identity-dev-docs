  ...
  <div class="desktop:grid-col-9 mobile:grid-col-full">
    ...
    <div class="dev-doc-row">
      <div class="grid-row">
        ...
        <div class="grid-col-7">
          <p>If you know that a user would prefer one of our alternative language translations - currently Spanish, French or Chinese (Simplified). You can include the <code class="language-plaintext highlighter-rouge">locale</code> parameter to specify the language Login.gov should display. Use either <code class="text-lowercase">ES</code> for Spanish, <code class="text-lowercase">FR</code> for French, or <code class="text-lowercase">ZH</code> for Chinese (Simplified).</p>
        </div>
      </div>
    </div>
  </div>
