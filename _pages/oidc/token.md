...
<div class="grid-row grid-gap">
  <div class="desktop:grid-col-8 mobile:grid-col-full">
    ...
    <div class="dev-doc-row">
      <div class="grid-row">
        <div class="grid-col-5">
          <h4 class="parameters">vot <span class="text-normal">(string)</span></h4>
        </div>
        <div class="grid-col-7">
          The <a href="{{ '/vot-trust-framework/' | prepend: site.baseurl }}" class="usa-link">vector of trust</a> value of the returned claims.
        </div>
      </div>
    </div>
    <div class="dev-doc-row">
