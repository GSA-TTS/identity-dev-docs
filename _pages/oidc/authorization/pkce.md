...
<div class="grid-row grid-gap">
  ...
  <ul class="doc-sub-nav">
    <li id="jwt-nav" class="doc-sub-nav-item margin-left-neg-3"><a href="{{ '/oidc/authorization/#authorization' | prepend: site.baseurl }}">JWT</a></li>
    <li id="pkce-nav" class="doc-sub-nav-item code-button__selected margin-left-3"><a href="{{ '/oidc/authorization/pkce/#authorization' | prepend: site.baseurl }}">PKCE</a></li>
  </ul>
