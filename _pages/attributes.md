...
See [OpenID Connect IAL values](/oidc/authorization#request-parameters)
</td>
<td markdown="1">
`ial` (url, urn)

See [SAML IAL values](/saml/authentication#authentication-request)
</td>
    </tr>
    <tr>
<td markdown="1">
...
See [OpenID Connect AAL values](/oidc/authorization#request-parameters)
</td>
<td markdown="1">
`aal` (url, urn)

See [SAML AAL values](/saml/authentication#authentication-request)
</td>
    </tr>
    <tr>
<td markdown="1">
